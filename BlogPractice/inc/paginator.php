...
class paginator{
	...
	*/
	 ...
	 *  
	 * @param numeric  $_perPage  sets the number of items per page . for edit number of page just change   this:$this->_perPage = 4;
	...
	*/
	public function get_limit(){
        	...
        	// if u not use space after "LIMIT" , then u got error . so use: "LIMIT " ! 
        }
